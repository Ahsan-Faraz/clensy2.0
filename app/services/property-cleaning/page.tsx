...
export default function PropertyCleaningPage() {
  ...
  const getIconComponent = (iconName: string) => {
    switch (iconName) {
      case "Building":
        return <Building className="h-8 w-8 text-[#007BFF]" />;
      case "Clock":
        return <Clock className="h-8 w-8 text-[#007BFF]" />;
      case "Home":
        return <Home className="h-8 w-8 text-[#007BFF]" />;
      default:
        return <Building className="h-8 w-8 text-[#007BFF]" />;
    }
  };
    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative min-h-[85vh] bg-black pt-16">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="https://res.cloudinary.com/dgjmm3usy/image/upload/v1750846901/shutterstock_2129156702_qeucgi.jpg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center min-h-[calc(85vh-64px)]">
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight mb-6 hero-text-shadow">
                {data.heroHeading.includes("Common Areas") ? (
                  <>
                    {data.heroHeading.split("Common Areas")[0]}
                    <br />
                    <span className="text-white">
                      Common Areas{data.heroHeading.split("Common Areas")[1]}
                    </span>
                  </>
                ) : (
                  data.heroHeading
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-lg order-2 lg:order-1">
              <Image
                src="https://res.cloudinary.com/dgjmm3usy/image/upload/v1750847028/shutterstock_670152970_1_gsbf4k.jpg"
            ...
            <div className="order-1 lg:order-2">
              <h3 className="text-2xl font-bold mb-4">{data.lobbiesTitle}</h3>
              <p className="text-gray-600 mb-6">{data.lobbiesDescription}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <h3 className="text-2xl font-bold mb-4">{data.hallwaysTitle}</h3>
              <p className="text-gray-600 mb-6">{data.hallwaysDescription}</p>
              <ul className="space-y-3">
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-lg">
              <Image
                src="https://res.cloudinary.com/dgjmm3usy/image/upload/v1750847089/hallway-interior-design_d5danz.jpg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h3 className="text-2xl font-bold mb-4">
                {data.stairwellsTitle}
              </h3>
              <p className="text-gray-600 mb-6">{data.stairwellsDescription}</p>
              <ul className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl h-full flex flex-col">
              ...
              <div className="flex items-center mt-auto">
                ...
                <div>
                  <p className="font-semibold">Lauren Thompson</p>
                  <p className="text-white/60 text-sm">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl h-full flex flex-col">
              ...
              <p className="text-white/80 mb-6 flex-grow">
                "As a property developer, maintaining a pristine appearance in
                our buildings is crucial for attracting tenants. Clensy's
                attention to detail and reliable service have helped us maintain
                high occupancy rates and positive tenant reviews across all our
                properties."
              </p>
              <div className="flex items-center mt-auto">
                ...
                <div>
                  <p className="font-semibold">Jonathan Santiago</p>
                  <p className="text-white/60 text-sm">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600 text-center mb-12">
              Learn more about our property cleaning services.
            </p>
