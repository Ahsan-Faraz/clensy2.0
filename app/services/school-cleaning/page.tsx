...
export default function SchoolCleaningPage() {
  ...
  const getIconComponent = (iconName: string) => {
    switch (iconName) {
      ...
      case "Pencil":
        return <Pencil className="h-8 w-8 text-[#007BFF]" />;
      case "Sparkles":
        return <Sparkles className="h-8 w-8 text-[#007BFF]" />;
      default:
        return <Shield className="h-8 w-8 text-[#007BFF]" />;
    }
  };
    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative min-h-[85vh] bg-black pt-16">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="https://res.cloudinary.com/dgjmm3usy/image/upload/v1750846630/photo-1580582932707-520aed937b7b_h9uf5z.jpg"
              ...
              >
                ...
                <div className="flex items-center sm:mt-0 mt-4">
                  <div className="flex items-center text-white/90 mr-8">
                    <BookOpen className="h-5 w-5 mr-2 text-[#007BFF]" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-lg order-2 lg:order-1">
              <Image
                src="https://res.cloudinary.com/dgjmm3usy/image/upload/v1750846661/photo-1588072432836-e10032774350_ydjsls.jpg"
                alt="School classroom cleaning"
                fill
            ...
            <div className="order-1 lg:order-2">
              <h3 className="text-2xl font-bold mb-4">
                {data.classroomsTitle}
              </h3>
              <p className="text-gray-600 mb-6">{data.classroomsDescription}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <h3 className="text-2xl font-bold mb-4">
                {data.cafeteriasTitle}
              </h3>
              <p className="text-gray-600 mb-6">{data.cafeteriasDescription}</p>
              <ul className="space-y-3">
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-lg">
              <Image
                src="https://res.cloudinary.com/dgjmm3usy/image/upload/v1750846752/shutterstock_2567781381_apqkc9.jpg"
                alt="School restroom cleaning"
                fill
                className="object-cover"
              />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-lg order-2 lg:order-1">
              <Image
                src="https://res.cloudinary.com/dgjmm3usy/image/upload/v1750846826/image64_pqa4og.png"
                alt="School playground cleaning"
                fill
                className="object-cover"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-50 rounded-full mb-6">
                <Image
                  src={data.feature1Icon}
                  alt={data.feature1Title}
                  width={32}
                  height={32}
                  className="w-8 h-8"
                />
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-50 rounded-full mb-6">
                <Image
                  src={data.feature2Icon}
                  alt={data.feature2Title}
                  width={32}
                  height={32}
                  className="w-8 h-8"
                />
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-50 rounded-full mb-6">
                <Image
                  src={data.feature3Icon}
                  alt={data.feature3Title}
                  width={32}
                  height={32}
                  className="w-8 h-8"
                />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-white/80">
              Discover why schools and childcare centers trust us for their
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl h-full flex flex-col">
              ...
              <p className="text-white/80 mb-6 flex-grow italic">
                "Clensy has been instrumental in maintaining a clean and healthy
                environment for our students. Their attention to detail and use
                of child-safe products gives us complete peace of mind."
              </p>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl h-full flex flex-col">
              ...
              <p className="text-white/80 mb-6 flex-grow italic">
                "The flexibility of their scheduling has been amazing. They work
                around our school hours and special events, ensuring minimal
                disruption to our educational programs."
              </p>
              <div className="flex items-center mt-auto">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl h-full flex flex-col">
              ...
              <p className="text-white/80 mb-6 flex-grow italic">
                "Since partnering with Clensy, we've noticed a significant
                reduction in sick days among our staff and students. Their
                thorough sanitization protocols make a real difference."
              </p>
              <div className="flex items-center mt-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600 text-center mb-12">
              Common questions about our school and childcare cleaning services.
            </p>

            <div className="space-y-8">
              {data?.faqs && data.faqs.length > 0 ? (
                data.faqs.map((faq, idx) => (
                  <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border-l-4 border-[#007BFF]">
