...
export class CMSAdapter {
  ...
  static async getServiceBySlug(slug: string, status: 'draft' | 'published' = 'published') {
    ...
    const servicePopulate = {
      ...
      htmlBlocks: true,
      extrasPricing: true,
      premiumExtraServices: true,
      howToAddExtraServicesSteps: true,
      extrasTrustIndicators: true,
      extrasClientTestimonials: true,
      reduceStressSection: { populate: { benefits: true } },
      beforeAfter: { populate: { items: true } },
      deepCleaningComparison: { populate: { regularCleaning: { populate: { features: true } }, deepCleaning: { populate: { features: true } } } },
      whenToChoose: { populate: { options: true } },
      successStories: { populate: { items: true } },
      serviceFeatures: true,
      businessBenefits: { populate: { cards: true } },
      specializedEquipment: { populate: { items: true } },
      healthAndSafetyStandards: { populate: { items: true } },
    ...
    const transformed = {
      ...
      // Extras service – structured components (preferred over customData when present)
      extrasPricing: data.extrasPricing || null,
      premiumExtraServices: data.premiumExtraServices || null,
      howToAddExtraServicesSteps: data.howToAddExtraServicesSteps || null,
      extrasTrustIndicators: data.extrasTrustIndicators || null,
      ...
      deepCleaningComparison: data.deepCleaningComparison || null,
      whenToChoose: data.whenToChoose || null,
      successStories: data.successStories || null,
      serviceFeatures: data.serviceFeatures || null,
      businessBenefits: data.businessBenefits || null,
      specializedEquipment: data.specializedEquipment || null,
      healthAndSafetyStandards: data.healthAndSafetyStandards || null,
      serviceTrustIndicators: data.serviceTrustIndicators || null,
      movingClientTestimonials: data.movingClientTestimonials || null,
      postConstructionSafety: data.postConstructionSafety || null,
      postConstructionStep4Title: data.postConstructionStep4Title || null,
      postConstructionStep4Description: data.postConstructionStep4Description || null,
      postConstructionClientTestimonials: data.postConstructionClientTestimonials || null,
      benefit1Icon: data.benefit1Icon || null,
      benefit2Icon: data.benefit2Icon || null,
      benefit3Icon: data.benefit3Icon || null,
    };
