        ...
        headers: [
          {
            ...
            value: "frame-ancestors 'self' http://localhost:1337 https://clensy2-0.vercel.app https://*.vercel.app https://*.railway.app https://*.up.railway.app https://strapi-production-8d56.up.railway.app https://*.onrender.com https://strapi1-1-6oqs.onrender.com http://72.60.27.190;",
          },
        ],
      },
    ];
